...
console.log(userSayHello.apply(user3)); // output / Hello Bran //msg port closed before a response was received
console.log(userSayHello.call(user3)); // output / Hello Bran
console.log(typeof new MainUser()); // output / obj
console.log(typeof new MainUser()); // output / ibj
